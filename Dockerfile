...
# pyg
RUN pip3 install assets/pyg_wheels/torch_scatter-2.1.0+pt112cu113-cp37-cp37m-linux_x86_64.whl
RUN pip3 install assets/pyg_wheels/torch_sparse-0.6.16+pt112cu113-cp37-cp37m-linux_x86_64.whl
RUN pip3 install assets/pyg_wheels/torch_cluster-1.6.0+pt112cu113-cp37-cp37m-linux_x86_64.whl
RUN pip3 install assets/pyg_wheels/torch_spline_conv-1.2.1+pt112cu113-cp37-cp37m-linux_x86_64.whl
